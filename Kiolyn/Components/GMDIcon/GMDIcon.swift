...
public extension UIButton {
    ...
    */
    func setGMDIcon(icon: GMDType, forState state: UIControlState, fontSize: CGFloat) {
...
private class FontLoader {
    private static var setUpOnce = DispatchOnce()
        ...
        if (UIFont.fontNames(forFamilyName: GMDStruct.FontName).count == 0) {
            ...
            setUpOnce.perform {
                ...
                if identifier?.hasPrefix("org.cocoapods") == true {
                    ...
                    fontURL = bundle.url(forResource: GMDStruct.FileFontName, withExtension: "ttf", subdirectory: "Google-Material-Design-Icons-Swift.bundle")! as NSURL
                } else {
                    
                    fontURL = bundle.url(forResource: GMDStruct.FileFontName, withExtension: "ttf")! as NSURL
                }
